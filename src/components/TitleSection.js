            ...
            <div className='title-section' >
                ...
                <div className={'main-info ' + infoOpen} >
                    ...
                    {/* {true && (<div> */}
                        ...
                        <p>I was a quiet and curious kid, shy but with little fear of the world. I was individualistic and brave, I thought a thing and then did a thing, often oblivious to what was going on around. Throughout school I could appear disinterested but often got the highest marks. Especially in Maths and science, they seemed quite obvious to me. I also enjoyed the subjects where I could make things. I chose Art, music and design technology for GCSEs where I created things I was proud of. Outside of school I liked exploring the mean streets of Bradford, long walks with my family, playstation, football, guitar and fighting with my brother.</p>
                    ...
                    {this.state.openInfos[1] && (<div>
                        ...
                        <p>In the gaps, as well as still tutoring, I completed a free code camp course, with tricky algorithm challenges and creating things like a calculator and local weather app. I then decided to specialise in react and bought a series of lectures. After just 2 weeks of learning about npm, webpack, components and state, I made a noughts and crosses game and was pleasantly surprised by this new setup's power and usability.</p>
